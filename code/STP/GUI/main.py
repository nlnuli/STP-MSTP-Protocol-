...
class Demo(QWidget, Ui_Form):
    ...
    def open_btn_clicked(self):
        ...
        second_main.show2(self.another_window)
        second_main.show3(self.another_window)
    ...
    def mstp_start(self):
        ...
        print('文件输入 mstp开始')
        os.system(r'python3 /Users/yewen/Desktop/2023毕业设计/code/STP/MSTP/mstp.py')
        print(fp)

    def stp_start(self):
        print('文件输入 stp开始')
        fp = self.lineEdit.text()
        os.system(r'python3 /Users/yewen/Desktop/2023毕业设计/code/STP/STP/stp.py')
        print(fp)
    ...
    def stp_data(self):
        ...
        for i in range(rows):
            ...
            for j in range(cols):
                data = self.tableWidget_3.item(i, j)
                if data is None:
                    continue
    ...
    def mstp_data(self):
        ...
        #调用程序
        os.system(r'python /Users/yewen/Desktop/2023毕业设计/code/STP/STP/stp.py')
        print('done')
        print('运行结束')
